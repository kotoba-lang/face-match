...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("face-match bounded-no-matcher Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("face-match Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("face-match Wasm main mismatch");

console.log("face-match: bounded no-matcher Web/Wasm conformance passed");
